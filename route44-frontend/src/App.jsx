      ...
      <nav className="fixed top-0 w-full z-50 bg-[#f9f9f9]/80 dark:bg-zinc-950/80 backdrop-blur-xl transition-all duration-300">
        <div className="flex justify-between items-center px-12 py-6 max-w-[1920px] mx-auto">
          ...
          <div className="hidden md:flex gap-10 items-center">
            ...
            <a className="font-headline font-bold tracking-tight uppercase text-sm text-zinc-500 dark:text-zinc-400 hover:text-[#6e0609] transition-colors duration-300" href="#">Tracking</a>
            <a className="font-headline font-bold tracking-tight uppercase text-sm text-zinc-500 dark:text-zinc-400 hover:text-[#6e0609] transition-colors duration-300" href="#">Services</a>
            <a className="font-headline font-bold tracking-tight uppercase text-sm text-zinc-500 dark:text-zinc-400 hover:text-[#6e0609] transition-colors duration-300" href="#">About Us</a>
            <a className="font-headline font-bold tracking-tight uppercase text-sm text-zinc-500 dark:text-zinc-400 hover:text-[#6e0609] transition-colors duration-300" href="#">Contact</a>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 py-16 max-w-[1920px] mx-auto">
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-2">
              <a className="font-body text-xs tracking-wide uppercase font-medium text-zinc-500 dark:text-zinc-400 hover:text-[#1a1c1c] hover:translate-x-1 transition-transform duration-200" href="#">Freight Elite</a>
              <a className="font-body text-xs tracking-wide uppercase font-medium text-zinc-500 dark:text-zinc-400 hover:text-[#1a1c1c] hover:translate-x-1 transition-transform duration-200" href="#">Precision Ops</a>
              <a className="font-body text-xs tracking-wide uppercase font-medium text-zinc-500 dark:text-zinc-400 hover:text-[#1a1c1c] hover:translate-x-1 transition-transform duration-200" href="#">Carrier Network</a>
            </nav>
          </div>
          <div className="flex flex-col gap-4">
