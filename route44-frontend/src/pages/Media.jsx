...
function Media() {
  ...
  return (
    <div className="min-h-screen w-full neural-grid page-fade-in">
      <main
        ref={mainRef}
        className="pt-28 pb-16 px-6 md:px-margin-desktop max-w-container-max mx-auto w-full"
      >
        {/* ── Hero HUD ── */}
        <section className="mb-8">
          <div className="glass-panel p-6 border border-outline-variant/20 relative overflow-hidden">
            <div className="absolute top-0 right-0 p-5 flex flex-col items-end opacity-20 pointer-events-none select-none">
            ...
            <div className="max-w-xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-secondary/10 text-secondary border border-secondary/20 mb-4">
              ...
              <div className="flex-1 glass-panel border-outline-variant/30 flex items-center px-3 py-2.5 focus-within:ring-2 focus-within:ring-primary/20 transition-all max-w-md">
                ...
                <input
                  ...
                  className="bg-transparent border-none focus:outline-none focus:ring-0 w-full ml-2 text-sm text-on-surface placeholder:text-outline/60 font-body-md"
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-6 gap-4">
          ...
          <div className="hidden lg:flex gap-6 border-l border-outline-variant/30 pl-6">
            ...
            <div className="glass-panel h-full overflow-hidden flex flex-col hover:border-primary/40 transition-all duration-300">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  <span className="px-2.5 py-1 bg-primary text-on-primary text-label-sm font-label-sm uppercase">
                    Trends
                  </span>
                  <span className="px-2.5 py-1 bg-surface/90 backdrop-blur text-on-surface text-label-sm font-label-sm uppercase">
                    Featured
                  </span>
                </div>
              </div>
              <div className="p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-3 mb-3 font-mono-data text-mono-data text-outline uppercase">
                  <span>Oct 24, 2024</span>
                  <span className="w-1 h-1 rounded-full bg-outline" />
                  <span>12 Min Read</span>
                </div>
                <h2 className="font-headline-xl text-headline-xl text-primary mb-4 group-hover:text-secondary transition-colors">
                ...
                <div className="mt-auto flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-full bg-surface-container-highest border border-outline-variant overflow-hidden">
                      <img
                  ...
                  <span className="material-symbols-outlined text-[20px] text-primary group-hover:translate-x-2 transition-transform">
                    arrow_forward
                  </span>
                </div>
              </div>
            ...
            {[
              ...
              >
                <div className="h-36 overflow-hidden relative">
                  ...
                  />
                  <span
                    className={`absolute top-3 left-3 px-2.5 py-1 text-label-sm font-label-sm uppercase ${labelColor}`}
                  >
                    {label}
                  </span>
                </div>
                <div className="p-4">
                  <p className="font-mono-data text-mono-data text-outline uppercase mb-1.5">
                    {read}
                  </p>
                  <h3 className="font-headline-md text-headline-md text-primary mb-2 leading-tight group-hover:text-secondary transition-colors">
                    {title}
                  </h3>
        ...
        <h2 className="font-headline-lg text-headline-lg text-primary mb-5 border-l-4 border-secondary pl-4">
          Latest Dispatch Intelligence
        </h2>
          ...
          {articles.map(({ id, category, tag, title, desc, ref }) => (
            ...
            >
              <div className="p-5">
                ...
                <h3
                  className={`font-headline-md text-headline-md text-${tag} mb-3`}
                >
                  {title}
                </h3>
        ...
        {/* ── Newsletter CTA ── */}
        <section>
          <div className="bg-inverse-surface p-6 relative overflow-hidden">
            <div className="absolute inset-0 opacity-10 pointer-events-none grid-bg" />
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="max-w-lg">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-secondary/20 text-secondary mb-4">
                  <span className="w-2 h-2 bg-secondary animate-pulse" />
                  <span className="font-label-sm text-label-sm uppercase tracking-widest">
                    Dispatch Alerts
                  </span>
                </div>
                <h2 className="font-headline-xl text-headline-xl text-surface-container-lowest mb-3">
              ...
              {subscribed ? (
                <div className="text-center">
                  ...
                  <p className="font-headline-md text-headline-md text-white mt-3">
                    You're subscribed.
                  </p>
                </div>
              ) : (
                ...
                >
                  <input
                    ...
                    className="px-4 py-3 text-sm bg-white/10 border border-white/20 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-secondary min-w-[240px]"
                  />
                  <button
                    type="submit"
                    className="px-6 py-3 bg-secondary text-on-secondary font-label-md text-sm font-bold coral-glow hover:brightness-110 transition-all whitespace-nowrap"
                  >
                    Subscribe Now
                  </button>
                </form>
