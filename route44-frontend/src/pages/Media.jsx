...
function Media() {
  ...
  return (
    <main
      ref={mainRef}
      className="pt-36 pb-24 px-6 md:px-margin-desktop max-w-container-max mx-auto w-full neural-grid page-fade-in"
    >
      {/* ── Hero HUD ── */}
        ...
        <div className="glass-panel p-12 border border-outline-variant/20 relative overflow-hidden">
          ...
          <div className="max-w-2xl">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 leading-relaxed">
              Navigating the global trade arteries with real-time dispatch data
              and deep analytical forecasts. Explore our latest supply chain
              breakthroughs and internal fleet developments.
            </p>
          ...
          <div className="glass-panel h-full overflow-hidden flex flex-col hover:border-primary/40 transition-all duration-300">
            ...
            <div className="p-10 flex flex-col flex-grow">
              ...
              <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 line-clamp-3">
                Predictive logistics is no longer a luxury; it's the operational
                standard. Route 44 explores how machine learning models are
                reshaping the efficiency of European supply arteries, reducing
                carbon footprints by 22% while accelerating dispatch times.
              </p>
